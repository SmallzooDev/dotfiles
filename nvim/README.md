...
![Vim screenshot](http://smallzoo.io/img/project/vim-config/features.png)
...
1. Let's clone this repo! Clone to `~/.config/nvim`
    ...
    ```bash
    mkdir -p ~/.config
    git clone git@github.com:smallzoo/vim-config.git ~/.config/nvim
    cd ~/.config/nvim
    ```
...
See [lua/smallzoo/plugins/lsp/init.lua] for custom key-mappings and configuration
...
* [lua/](./lua) — Lua configurations
  ...
  * [smallzoo/](./lua/smallzoo)
    * [config/](./lua/config) — Neovim configurations
      * [autocmd.lua](./lua/smallzoo/config/autocmd.lua) — Auto-commands
      * [init.lua](./lua/smallzoo/config/init.lua) — Initialization
      * [keymaps.lua](./lua/smallzoo/config/keymaps.lua) — Key-mappings
      * [lazy.lua](./lua/smallzoo/config/lazy.lua) — Entry-point initialization
      * [options.lua](./lua/smallzoo/config/options.lua) — Editor settings
    * [plugins/](./lua/plugins) — Plugins and configurations
    * [util/](./lua/smallzoo/util) — Utility library
...
```json
{
  "extras": [
    ...
    "smallzoo.plugins.extras.lang.ansible",
    "smallzoo.plugins.extras.lang.go",
    "smallzoo.plugins.extras.lang.helm",
    "smallzoo.plugins.extras.lang.kubernetes",
    "smallzoo.plugins.extras.lang.markdown",
    "smallzoo.plugins.extras.lang.python",
    "smallzoo.plugins.extras.lang.tmux",
    "smallzoo.plugins.extras.ui.deadcolumn"
  ],
  "news": [],
  "version": 2
}
...
return {
  ...
  { import = 'smallzoo.plugins.extras.ui.incline' },
...
1. Create `lua/config/options.lua` and set any Neovim/SmallzooVim/LazyVim features:
...
1. You can completely override lazy.nvim setup by creating `lua/config/lazy.lua`
   to replace `lua/smallzoo/config/lazy.lua` with your own procedure.
...
| Name           | Description |
| -------------- | ---------------------- |
| [smallzoo/theme-loader.nvim] | Use last-used colorscheme |
| [smallzoo/neo-hybrid.vim] | Modern dark colorscheme, hybrid improved |
| [smallzoo/awesome-colorschemes] | Awesome color-schemes |
...
| [smallzoo/telescope-thesaurus.nvim] | Browse synonyms for a word |
...
[smallzoo/theme-loader.nvim]: https://github.com/smallzoo/theme-loader.nvim
[smallzoo/neo-hybrid.vim]: https://github.com/smallzoo/neo-hybrid.vim
[smallzoo/awesome-colorschemes]: https://github.com/smallzoo/awesome-vim-colorschemes
...
[smallzoo/telescope-thesaurus.nvim]: https://github.com/smallzoo/telescope-thesaurus.nvim
...
Following are extra-extras available with Smallzoo's Neovim on-top of LazyVim's:

### Extra Plugins: Coding

Spec: `smallzoo.plugins.extras.coding.<name>`
...
Spec: `smallzoo.plugins.extras.colorscheme.<name>`
...
Spec: `smallzoo.plugins.extras.editor.<name>`
...
Spec: `smallzoo.plugins.extras.git.<name>`
...
Spec: `smallzoo.plugins.extras.lang.<name>`
...
Spec: `smallzoo.plugins.extras.lsp.<name>`
...
Spec: `smallzoo.plugins.extras.org.<name>`
...
Spec: `smallzoo.plugins.extras.treesitter.<name>`
...
Spec: `smallzoo.plugins.extras.ui.<name>`
...
LazyVim is imported in specs (see [lua/smallzoo/config/lazy.lua](./lua/smallzoo/config/lazy.lua))
...
| Key   | Mode | Action             | Plugin or Mapping |
| ----- |:----:| ------------------ | ------ |
| <kbd>;</kbd>+<kbd>c</kbd> | Ⓝ | Open context-menu | <small>[lua/smallzoo/util/contextmenu.lua]</small> |
...
[lua/smallzoo/plugins/lsp/init.lua]: ./lua/smallzoo/plugins/lsp/init.lua
[nvim-lspconfig]: https://github.com/neovim/nvim-lspconfig
[blink.cmp]: https://github.com/saghen/blink.cmp
[nvim-cmp]: https://github.com/hrsh7th/nvim-cmp
[telescope.nvim]: https://github.com/nvim-telescope/telescope.nvim
[config/keymaps.lua]: ./lua/smallzoo/config/keymaps.lua
[util/edit.lua]: ./lua/smallzoo/util/edit.lua
[plugins/lsp/keymaps.lua]: ./lua/smallzoo/plugins/lsp/keymaps.lua
[lua/smallzoo/util/contextmenu.lua]: ./lua/smallzoo/util/contextmenu.lua
