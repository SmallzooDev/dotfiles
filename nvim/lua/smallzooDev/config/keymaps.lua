-- smallzooDev's Neovim keymaps
-- https://github.com/smallzooDev/vim-config
-- ===

-- This file is automatically loaded by lua/smallzooDev/config/lazy.lua
...
map('n', '<RightMouse>', function() require('smallzooDev.util.contextmenu').show() end, { desc = 'Context-aware menu' })
map('n', '<LocalLeader>c', function() require('smallzooDev.util.contextmenu').show() end, { desc = 'Context-aware menu' })
...
function _G.formatter_select() -- {{{
	...
	---@param bufnr number
	---@param source smallzooDev.Formatter
