-- Smallzoo's Neovim keymaps
-- https://github.com/smallzoo/vim-config
-- ===

-- This file is automatically loaded by lua/smallzoo/config/lazy.lua
...
map('n', '<RightMouse>', function() require('smallzoo.util.contextmenu').show() end, { desc = 'Context-aware menu' })
map('n', '<LocalLeader>c', function() require('smallzoo.util.contextmenu').show() end, { desc = 'Context-aware menu' })
...
function _G.formatter_select() -- {{{
	...
	---@param bufnr number
	---@param source smallzoo.Formatter
