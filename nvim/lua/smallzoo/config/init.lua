-- Smallzoo's Neovim config loader
...
M.deprecated_extras = {
	['smallzoo.plugins.extras.editor.telescope'] = '`telescope.nvim` is now the default **SmallzooVim** picker.',
	['smallzoo.plugins.extras.ui.indent-blankline'] = "Use LazyVim's `indent-blankline.nvim` instead.",
}

-- Load lua/smallzoo/config/* and user lua/config/* files.
---@param name 'autocmds' | 'options' | 'keymaps'
function M.load(name)
	local mod = 'smallzoo.config.' .. name
...
function M.setup()
	...
	-- Add lua/smallzoo/plugins/extras as list of "extra" sources.
	LazyVim.extras.sources = {
		...
		{
			name = 'Smallzoo ',
			desc = 'Smallzoo extras',
			module = 'smallzoo.plugins.extras',
		},
		{
			name = 'User ',
			desc = 'User extras',
